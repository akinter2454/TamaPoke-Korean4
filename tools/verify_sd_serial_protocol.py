...
assert m and m.group(1) == '3.63.0', m.group(1) if m else 'missing'
...
assert '3.63.0-ko-learnset-expansion-stability-framed-put4-single-release-fullsd-canonical-forms-regional-evolution-mega36' in html
...
print('SD/WebSerial protocol regression OK: fw=3.63.0 proto=4 framed exact-read + CRC + numbered retry ACK + atomic commit')
