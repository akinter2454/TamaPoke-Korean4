...
static const Trainer TRAINERS_GALAR[TRAINER_COUNT] = {
  { "MILO",   "TURFFIELD",  T_GRASS,    2, { {TP_NATDEX(829),19},{TP_NATDEX(830),20} } },
  { "NESSA",  "HULBURY",    T_WATER,    3, { {118,22},{TP_NATDEX(846),23},{TP_NATDEX(834),24} } },
  { "KABU",   "MOTOSTOKE",  T_FIRE,     3, { {38,25},{59,25},{TP_NATDEX(851),27} } },
  { "BEA",    "STOWSIDE",   T_FIGHTING, 4, { {237,34},{675,34},{TP_NATDEX(865),35},{68,36} } },
  { "OPAL",   "BALLONLEA",  T_FAIRY,    4, { {110,36},{303,36},{468,37},{TP_NATDEX(869),38} } },
  { "GORDIE", "CIRCHESTER", T_ROCK,     4, { {689,40},{213,40},{TP_NATDEX(874),41},{TP_NATDEX(839),42} } },
  { "PIERS",  "SPIKEMUTH",  T_DARK,     4, { {560,44},{687,45},{435,45},{TP_NATDEX(862),46} } },
  { "RAIHAN", "HAMMERLOCKE",T_DRAGON,   4, { {526,46},{330,47},{TP_NATDEX(844),46},{TP_NATDEX(884),48} } },
  { "MARNIE", "CHAMP CUP",  T_DARK,     5, { {510,47},{454,47},{560,47},{TP_NATDEX(877),48},{TP_NATDEX(861),49} } },
  { "BEDE",   "CHAMP CUP",  T_FAIRY,    4, { {303,51},{282,51},{78,52},{TP_NATDEX(858),53} } },
  { "HOP",    "CHAMP CUP",  T_FLYING,   5, { {TP_NATDEX(832),48},{143,47},{TP_NATDEX(871),47},{TP_NATDEX(823),48},{TP_NATDEX(815),49} } },
  { "ROSE",   "ROSE TOWER", T_STEEL,    5, { {589,55},{598,55},{601,56},{TP_NATDEX(863),55},{TP_NATDEX(879),57} } },
  { "LEON",   "CHAMPION",   T_DRAGON,   6, { {681,62},{TP_NATDEX(887),62},{612,63},{464,64},{TP_NATDEX(812),64},{6,65} } },
};
...
static const Trainer TRAINERS_PALDEA[TRAINER_COUNT] = {
  { "KATY",    "CORTONDO",    T_BUG,      3, { {TP_NATDEX(919),14},{TP_NATDEX(917),14},{216,15} } },
  { "BRASSIUS", "ARTAZON",    T_GRASS,    3, { {548,16},{TP_NATDEX(928),16},{185,17} } },
  { "IONO",    "LEVINCIA",    T_ELECTRIC, 4, { {TP_NATDEX(940),23},{TP_NATDEX(939),23},{404,23},{429,24} } },
  { "KOFU",    "CASCARRAFA",  T_WATER,    3, { {TP_NATDEX(976),29},{TP_NATDEX(961),29},{740,30} } },
  { "LARRY",   "MEDALI",      T_NORMAL,   3, { {775,35},{TP_NATDEX(982),35},{398,36} } },
  { "RYME",    "MONTENEVERA", T_GHOST,    4, { {354,41},{778,41},{TP_NATDEX(972),41},{TP_NATDEX(849),42} } },
  { "TULIP",   "ALFORNADA",   T_PSYCHIC,  4, { {TP_NATDEX(981),44},{282,44},{TP_NATDEX(956),44},{671,45} } },
  { "GRUSHA",  "GLASEADO",    T_ICE,      4, { {TP_NATDEX(873),47},{614,47},{TP_NATDEX(975),47},{334,48} } },
  { "RIKA",    "ELITE 4",     T_GROUND,   5, { {340,57},{323,57},{232,57},{51,57},{TP_NATDEX(980),58} } },
  { "POPPY",   "ELITE 4",     T_STEEL,    5, { {TP_NATDEX(879),58},{462,58},{437,58},{TP_NATDEX(823),58},{TP_NATDEX(959),59} } },
  { "LARRY",   "ELITE 4",     T_FLYING,   5, { {357,59},{741,59},{334,59},{398,59},{TP_NATDEX(973),60} } },
  { "HASSEL",  "ELITE 4",     T_DRAGON,   5, { {715,60},{612,60},{691,60},{TP_NATDEX(841),60},{TP_NATDEX(998),61} } },
  { "GEETA",   "CHAMPION",    T_NORMAL,   6, { {TP_NATDEX(956),61},{673,61},{TP_NATDEX(976),61},{713,61},{TP_NATDEX(983),61},{TP_NATDEX(970),62} } },
};
